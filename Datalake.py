...
def main():
    ...
    top_tracks.to_parquet(f's3://s3-testing1305/Test-Batch/top-tracks.parquet', engine='pyarrow', compression='snappy')

    ## 압축된 top_track 데이터 s3에 저장
    data = open(f'top-tracks.parquet', 'rb')
    ...
    audio_features.to_parquet(f's3://s3-testing1305/Test-Batch/top-tracks.parquet', engine='pyarrow', compression='snappy')
